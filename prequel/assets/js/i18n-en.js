...
const JH_I18N_EN = {
  ...
  // ── market/listing.html 留言串 ──
  "查看留言": "View comments",
  "買家": "Buyer",
  "不好意思這幾天比較忙,晚點回你": "Sorry, been busy the past few days, I'll get back to you later",
  "價格可以再談嗎?": "Can we talk about the price?",
  "先問問,不方便回沒關係": "Just asking, no worries if you can't reply",
  "剛上架就看到,太幸運了,還在嗎?": "Saw it right when it was listed, so lucky — still available?",
  "半年沒動了,是不是已經不賣了": "Hasn't moved in six months, is it not for sale anymore?",
  "可以,約晚上比較方便": "Sure, evening works better for me",
  "可以先匯訂金保留嗎?": "Can I wire a deposit to hold it?",
  "可以先看實品再決定嗎?": "Can I see the actual item before deciding?",
  "可以分期付款嗎?": "Can I pay in installments?",
  "可以宅配嗎?": "Can you ship it?",
  "在的,價格可以小談": "Still here, price can be discussed a bit",
  "在的,現在人剛好在靖河,可以約時間面交": "Still here — I happen to be in Jinghe right now, we can set up a time to meet",
  "外殼完整,沒有明顯刮傷": "Case is intact, no visible scratches",
  "外殼完整度怎麼樣?想問到都不好意思了": "How's the condition of the case? I feel bad for asking so many times",
  "外殼有刮傷嗎?": "Any scratches on the case?",
  "外觀完整度怎麼樣?": "How's the overall condition?",
  "已經賣掉了,不好意思": "Already sold, sorry",
  "已讀不回是賣掉了嗎?": "Read but no reply — does that mean it's sold?",
  "急需這張,拜託回覆一下": "Really need this one, please reply",
  "抱歉太晚回,還在的話再私訊我": "Sorry for the late reply, message me again if it's still available",
  "抱歉目前不方便面交,先保留": "Sorry, can't meet up right now, I'll hold it for now",
  "掛快一年了都沒回,還是撤下來比較好吧": "It's been up almost a year with no reply, maybe you should just take it down",
  "收藏很久了想入手,可以私訊我嗎": "Been wanting this for my collection for a while, can you DM me?",
  "最後問一次,真的不賣了嗎": "Asking one last time, really not selling anymore?",
  "有實際拍照嗎?想看內頁": "Do you have real photos? Want to see the inside pages",
  "求保留,今晚匯款": "Please hold it, I'll transfer the money tonight",
  "求保留,這禮拜就能匯款": "Please hold it, I can pay this week",
  "盒損可以接受,價格能不能再低一點": "I'm fine with box damage, can the price come down a bit?",
  "私訊給你細節": "I'll DM you the details",
  "站內詢問過了,想確認還有貨": "Already asked through the site, just confirming it's still in stock",
  "站內詢問過好幾次了,想再問一次還有貨嗎": "Asked through the site a few times already, checking again if it's still available",
  "簽名是本人現場簽的嗎?": "Was the signature done in person?",
  "簽名是本人現場簽的嗎?想確認一下": "Was the signature done in person? Just want to confirm",
  "請問還可以議價嗎": "Is the price still negotiable?",
  "跟另一個版本比起來哪個比較稀有?": "Which is rarer compared to the other version?",
  "這個版本台灣總共有幾張啊": "How many copies of this version are there in Taiwan?",
  "這張還有貨嗎?": "Is this one still in stock?",
  "運費另外算還是包含在內?": "Is shipping extra or included?",
  "運費另計,面交免運": "Shipping charged separately, free if meeting in person",
  "還在,可以面交": "Still available, can meet in person",
  "還在嗎?": "Still available?",
